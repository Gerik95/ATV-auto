            ...
            <div className="wrapper">
                <div className="footer_grid">
                    ...
                    <div className="prices">
                        ...
                        ст. 437 Гражданского кодекса Российской Федерации, и могут быть изменены в любое время без предупреждения. 
                        Все материалы сайта, включая тексты, фотографии, иконки, графику, дизайн и структуру страниц, 
                        являются объектами авторских прав. Копирование и использование материалов без письменного разрешения 
                        правообладателя запрещено. <br />
                        2016—{new Date().getFullYear()} © ООО «Лидер». Все права защищены.
