        ...
        <div className="suspention-corner section-item block_wrap">
            <div className="section-item-right">
                <div className="section-item-left-header">
                    <p className='item-right-h'>Уважаемые клиенты!<br /> <span className='span-item-right'>ATV-Авто "Пулково"</span> предлагает услуги квалифицированного мастера
                        стенда регулировки углов развала-схождения колёс. В целях безопасной эксплуатации Вашего автомобиля,
                        мы рекомендуем Вам пройти диагностику регулировки углов развала-схождения колёс Вашего автомобиля на
                ...
                <p className='item-right-h'>
                    ...
                    Развал-схождение легкового автомобиля(1 ось): <span className='span-item-right'>1500 рублей</span><br />
                    Развал-схождение легкового автомобиля(2 оси): <span className='span-item-right'>2000 рублей</span><br />
