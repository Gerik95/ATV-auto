                ...
                <div className="wrapper">
                    ...
                    <div className="about_company block_wrap">
                        ...
                        <p className="cooperation_info_text">Дорогие друзья, <span className='span-item-right'>«ATV-Aвто "Пулково"»</span> на рынке
                            ...
                            самое современное оборудование и инструменты. У нас работают лучшие профессионалы своего дела. Также мы являемся
                            единственным дилером, на территории г.Санкт-Петербурга и Ленинградской области, компании ProLAMP -
                            диодное освещение для авто-мото техники.
